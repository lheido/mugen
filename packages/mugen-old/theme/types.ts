...
import { ThemeElement } from "./properties";
...
//   | keyof T["sizes"]
//   | `minus_${keyof T["sizes"] extends string ? keyof T["sizes"] : string}`
//   | undefined;
...
// export const themeTransformValues = [
//   "translateX",
//   "translateY",
//   "translateZ",
//   "scale",
...
//   "skewY",
// ] as const;
// export type ThemeTransform<T extends ThemeDescription> = Record<
//   (typeof themeTransformValues)[number],
//   | KeyOfSizes<T>
//   | ThemeArrayValues<KeyOfSizes<T>>
//   | ThemeRecordValues<"x" | "y" | "z", KeyOfSizes<T>>
// >;
...
export type ThemeEvent<T extends ThemeDescription> = Partial<
  Record<keyof T["eventNames"], ThemeElement<T>>
>;

export type ThemeMedia<T extends ThemeDescription> = Partial<
  Record<keyof T["breakpoints"], ThemeElement<T> & ThemeEvent<T>>
>;
